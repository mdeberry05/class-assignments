 ...
 * This Driver does not have inline comments/documentation per an email sent out requiring comments
 * for the ArrayFunctions Class. 
 * 
 * @author L. Lehmann
 * @version 4/15/2014
 */
public class Driver
{
   ...
   { 
       double[] testArray = {3, 6, 2, 5, 12, 4, 1, 7};
       double[] results;
